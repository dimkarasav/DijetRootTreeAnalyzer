...
#        if options.model =="gg_qg_qq" and options.box=="CaloDijet2016_PFDijet2016":
        if options.model =="gg_qg_qq":
            ...
            legThyModel2 = rt.TLegend(0.45,0.54,0.9,0.7)            
   ...
   #     legThyModel.Draw("same")     # theory model change here
        try:
	...
	#h_limit.GetXaxis().SetLabelOffset(1000)
        ...
        if options.combinedMethods:
            ...
            l5 = rt.TLatex()
            l5.SetTextAlign(11)
            l5.SetTextSize(0.022)
            l5.SetNDC()
            l5.SetTextFont(72)
            l5.DrawLatex(0.195,0.82,"Fit Method")
#            l5.DrawLatex(0.21,0.65,"Fit Method")   # spin 1 format
           # l5.DrawLatex(0.185,0.641,"Method")
            l5.DrawLatex(0.328,0.82,"Ratio Method") #spin 1 format
#            l5.DrawLatex(0.42,0.65,"Ratio Method")
        xLab = rt.TLatex()
