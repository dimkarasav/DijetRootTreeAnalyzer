...
void Superimposing_Ratios_Width_Comparison_spin_1() {

	gROOT->LoadMacro("setTDRStyle_teliko.C");
	 setTDRStyle_teliko();

	int Superimposing_Xstart = 2700 ,Superimposing_Xend = 6000;
	double Superimposing_Ystart = 0.001 ,Superimposing_Yend = 10. ;
	int Ratio_Xstart = 2700 ,Ratio_Xend = 6000;
	double Ratio_Ystart = 0. ,Ratio_Yend = 2.2, Ratio_Yend_obs = 2.2 ;
	...
	char *output_directory = "../Final_Results_EXO-19-012/Ratio_Method/Wide_resonances/limits/Spin_1/Correct_shapes/";  

	char *limits_directory = "Final_Results_EXO-19-012/Standard_Fit/Wide_resonances/limits/Spin_1/Correct_shapes/";  
...
//	char *limits_directory_mc = "Final_Results_EXO-19-012/Ratio_Method/Wide_resonances/limits/Spin_2/";
	char *limits_directory_mc = "Final_Results_EXO-19-012/Ratio_Method/Wide_resonances/limits/Spin_1/Correct_shapes/";
