...
if __name__=="__main__":
    ...
    file_wide=TFile("../../EXO_19-012/Wide_resonances/limits//grFinal_PFDMV-q_qPrime-limit_137p5fb.root")
...
#    print '3'
 ...
 #   myFunc=TF1("myFunc","pow((x-1/(12*3.141592653))*(4*3.141592653)/6,0.5)",minwidth,0.3)
    myFunc=TF1("myFunc","sqrt( 2*3.141592653*x/3 )",minwidth,maxwidth)
...
#    leg2=TLegend(0.09,0.935,0.25,0.935," #bf{CMS #it{Preliminary}}")
    ...
    l5 =TLatex()
    l5.SetTextAlign(11)
    l5.SetTextSize(0.031)
    l5.DrawLatex(1900,0.265,"m_{DM} > M_{Med} / 2")
    l5.DrawLatex(1900,0.195,"m_{DM} = 0")

    line =TLine(med_min,0.182,med_max,0.182)
    line.SetLineStyle(9)
    line.SetLineWidth(1)
    line.SetLineColor(1)
    line.Draw("same")
 ...
 #   line_test =TLine(med_min,0.323604183,med_max,0.323604183) # coupling corresponding to 0.05 width, plots the line as a test
 ...
 #   line_test.Draw("same")
    ...
    line2 = TLine(med_min,0.25,med_max,0.25)
    ...
    if isGQ:
        ...
        if isLogx:
            canvas.SaveAs("../../EXO_19-012/Wide_resonances/limits/wide_gqprime-limit_137p5fb_final_logx.pdf")
        else:
            canvas.SaveAs("../../EXO_19-012/Wide_resonances/limits//wide_gqprime-limit_137p5fb_final.pdf")
            canvas.SaveAs("../../EXO_19-012/Wide_resonances/limits//wide_gqprime-limit_137p5fb_final.png")
