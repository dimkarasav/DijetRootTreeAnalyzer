...
h_CEMF_test2->Fill(jetCemfAK4->at(sortedJetIdx[1]));
	 ...
	 double C_SF_j1_l = 1;
	     ...
	     if (abs(hFlavourAK4->at(sortedJetIdx[0]))==5)
	       {
                 C_SF_j1_l =breader_Bloose_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
		 C_SF_j1_m =breader_Bmedium_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
		 C_SF_j1_t =breader_Btight_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
	       }
	     else if (abs(hFlavourAK4->at(sortedJetIdx[0]))==4) 
	       {
		 C_SF_j1_l =breader_Cloose_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
                 C_SF_j1_m =breader_Cmedium_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
                 C_SF_j1_t =breader_Ctight_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
               }
	     else
               {
		 C_SF_j1_l =0;
         ...
         //cout<<"SF_c\t"<<breader_Bloose_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt())<<endl;
	    ...
	    //Jet 2
             if (abs(hFlavourAK4->at(sortedJetIdx[1]))==5)
               { 
                 C_SF_j2_l =breader_Bloose_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
                 C_SF_j2_m =breader_Bmedium_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
                 C_SF_j2_t =breader_Btight_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
               }
             else if (abs(hFlavourAK4->at(sortedJetIdx[1]))==4) 
               { 
                 C_SF_j2_l =breader_Cloose_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
                 C_SF_j2_m =breader_Cmedium_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
                 C_SF_j2_t =breader_Ctight_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
               }
             else
               {
		 C_SF_j2_l =0;
	 ...
	 fillVariableWithValue("CSVv2SF_l_j1",C_SF_j1_l);
         ...
         if(!isData)
         {
            //Jet 1
             if (abs(hFlavourAK4->at(sortedJetIdx[0]))==5)
               {
                 D_SF_j1_l =breader_Bloose_DeepCSV94X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
                 D_SF_j1_m =breader_Bmedium_DeepCSV94X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
                 D_SF_j1_t =breader_Btight_DeepCSV94X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
               }
             else if (abs(hFlavourAK4->at(sortedJetIdx[0]))==4)
               {
                 D_SF_j1_l =breader_Cloose_DeepCSV94X->eval_auto_bounds("down", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
                 D_SF_j1_m =breader_Cmedium_DeepCSV94X->eval_auto_bounds("down", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
                 D_SF_j1_t =breader_Ctight_DeepCSV94X->eval_auto_bounds("down", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
               }
             else
               {
                 D_SF_j1_l =0;
            ...
            //Jet 2
             if (abs(hFlavourAK4->at(sortedJetIdx[1]))==5)
               {
                 D_SF_j2_l =breader_Bloose_DeepCSV94X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
                 D_SF_j2_m =breader_Bmedium_DeepCSV94X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
                 D_SF_j2_t =breader_Btight_DeepCSV94X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
               }
             else if (abs(hFlavourAK4->at(sortedJetIdx[1]))==4) 
               {
                 D_SF_j2_l =breader_Cloose_DeepCSV94X->eval_auto_bounds("down", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
                 D_SF_j2_m =breader_Cmedium_DeepCSV94X->eval_auto_bounds("down", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
                 D_SF_j2_t =breader_Ctight_DeepCSV94X->eval_auto_bounds("down", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
               }
             else 
               {
                 D_SF_j2_l = 0;
