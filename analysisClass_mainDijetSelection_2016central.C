...
*/    
  ...
  /*  std::string L1DATAPath = "data/2017MC/Fall17_17Nov2017_V4_DATA_L1FastJet_AK4PFchs.txt";
    ...
    std::string L1Path = "data/Summer16_23Sep2016V4_MC/Summer16_23Sep2016V4_MC_L1FastJet_AK4PFchs.txt";
    std::string L2Path = "data/Summer16_23Sep2016V4_MC/Summer16_23Sep2016V4_MC_L2Relative_AK4PFchs.txt";
    std::string L3Path = "data/Summer16_23Sep2016V4_MC/Summer16_23Sep2016V4_MC_L3Absolute_AK4PFchs.txt";
...
unc = new JetCorrectionUncertainty("data/Summer16_23Sep2016V4_MC/Summer16_23Sep2016V4_MC_Uncertainty_AK4PFchs.txt");
  ...
  bcalib94XCSVv2   = new BTagCalibration("DeepCSV"  , "data/bTag_MC_ScalingFactors/DeepCSV_Moriond17_B_H.csv");
  bcalib94XDeepCSV = new BTagCalibration("CSVv2", "data/bTag_MC_ScalingFactors/CSVv2_Moriond17_B_H.csv");

  //loose WP
  breader_Bloose_CSVv294X    = new BTagCalibrationReader(BTagEntry::OP_LOOSE ,"central", {"up", "down"});
  breader_Bloose_CSVv294X->load(*bcalib94XCSVv2, BTagEntry::FLAV_B,"comb");
  breader_Cloose_CSVv294X    = new BTagCalibrationReader(BTagEntry::OP_LOOSE ,"central", {"up", "down"});
  breader_Cloose_CSVv294X->load(*bcalib94XCSVv2, BTagEntry::FLAV_C,"comb");
  breader_Bloose_DeepCSV94X  = new BTagCalibrationReader(BTagEntry::OP_LOOSE ,"central", {"up", "down"});
  breader_Bloose_DeepCSV94X->load(*bcalib94XDeepCSV, BTagEntry::FLAV_B,"comb");
  breader_Cloose_DeepCSV94X  = new BTagCalibrationReader(BTagEntry::OP_LOOSE ,"central", {"up", "down"});
  breader_Cloose_DeepCSV94X->load(*bcalib94XDeepCSV, BTagEntry::FLAV_C,"comb");
 
   //medium WP
  breader_Bmedium_CSVv294X   = new BTagCalibrationReader(BTagEntry::OP_MEDIUM,"central", {"up", "down"});
  breader_Bmedium_CSVv294X->load(*bcalib94XCSVv2, BTagEntry::FLAV_B,"comb");
  breader_Cmedium_CSVv294X   = new BTagCalibrationReader(BTagEntry::OP_MEDIUM,"central", {"up", "down"});
  breader_Cmedium_CSVv294X->load(*bcalib94XCSVv2, BTagEntry::FLAV_C,"comb");
  breader_Bmedium_DeepCSV94X = new BTagCalibrationReader(BTagEntry::OP_MEDIUM,"central", {"up", "down"});
  breader_Bmedium_DeepCSV94X->load(*bcalib94XDeepCSV, BTagEntry::FLAV_B,"comb");
  breader_Cmedium_DeepCSV94X = new BTagCalibrationReader(BTagEntry::OP_MEDIUM,"central", {"up", "down"});
  breader_Cmedium_DeepCSV94X->load(*bcalib94XDeepCSV, BTagEntry::FLAV_C,"comb");

  //tight WP
  breader_Btight_CSVv294X    = new BTagCalibrationReader(BTagEntry::OP_TIGHT ,"central", {"up", "down"});
  breader_Btight_CSVv294X->load(*bcalib94XCSVv2, BTagEntry::FLAV_B,"comb");
  breader_Ctight_CSVv294X    = new BTagCalibrationReader(BTagEntry::OP_TIGHT ,"central", {"up", "down"});
  breader_Ctight_CSVv294X->load(*bcalib94XCSVv2, BTagEntry::FLAV_C,"comb");
  breader_Btight_DeepCSV94X  = new BTagCalibrationReader(BTagEntry::OP_TIGHT ,"central", {"up", "down"});
  breader_Btight_DeepCSV94X->load(*bcalib94XDeepCSV, BTagEntry::FLAV_B,"comb");
  breader_Ctight_DeepCSV94X  = new BTagCalibrationReader(BTagEntry::OP_TIGHT ,"central", {"up", "down"});
  breader_Ctight_DeepCSV94X->load(*bcalib94XDeepCSV, BTagEntry::FLAV_C,"comb");
...
//cout << correction << endl;
     ...
     if( AK4jets.size() >=1 ){
       ...
       fillVariableWithValue( "jetDeepCSVAK4_j1", jetDeepCSVAK4->at(sortedJetIdx[0]) );
       fillVariableWithValue("jetHflavour_j1",hFlavourAK4->at(sortedJetIdx[0]));
       fillVariableWithValue("jetpflavour_j1",pFlavourAK4->at(sortedJetIdx[0]));
     ...
     if( AK4jets.size() >=2 ){
       ...
       fillVariableWithValue( "jetDeepCSVAK4_j2", jetDeepCSVAK4->at(sortedJetIdx[1]) );
       fillVariableWithValue("jetHflavour_j2",hFlavourAK4->at(sortedJetIdx[1]));
       fillVariableWithValue("jetpflavour_j2",pFlavourAK4->at(sortedJetIdx[1]));
       //jetID
...
h_CEMF_test2->Fill(jetCemfAK4->at(sortedJetIdx[1]));
	 ...
	 double C_SF_j1_l = 1;
         ...
         {
            //Jet 1
	     if (abs(hFlavourAK4->at(sortedJetIdx[0]))==5)
	       {
                 C_SF_j1_l =breader_Bloose_CSVv294X->eval_auto_bounds("central", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
		 C_SF_j1_m =breader_Bmedium_CSVv294X->eval_auto_bounds("central", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
		 C_SF_j1_t =breader_Btight_CSVv294X->eval_auto_bounds("central", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
	       }
	     else if (abs(hFlavourAK4->at(sortedJetIdx[0]))==4) 
	       {
		 C_SF_j1_l =breader_Cloose_CSVv294X->eval_auto_bounds("central", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
                 C_SF_j1_m =breader_Cmedium_CSVv294X->eval_auto_bounds("central", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
                 C_SF_j1_t =breader_Ctight_CSVv294X->eval_auto_bounds("central", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
               }
	     else
               {
		 C_SF_j1_l =0;
         ...
         //cout<<"Flavour\t"<<abs(hFlavourAK4->at(sortedJetIdx[0]))<<endl;
         //cout<<"SF_u\t"<<breader_Bloose_CSVv294X->eval_auto_bounds("up", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt())<<endl;
         //cout<<"SF_c\t"<<breader_Bloose_CSVv294X->eval_auto_bounds("central", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt())<<endl;
         //cout<<"SF_d\t"<<breader_Bloose_CSVv294X->eval_auto_bounds("down", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt())<<endl;

	    //Jet 2
             if (abs(hFlavourAK4->at(sortedJetIdx[1]))==5)
               { 
                 C_SF_j2_l =breader_Bloose_CSVv294X->eval_auto_bounds("central", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
                 C_SF_j2_m =breader_Bmedium_CSVv294X->eval_auto_bounds("central", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
                 C_SF_j2_t =breader_Btight_CSVv294X->eval_auto_bounds("central", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
               }
             else if (abs(hFlavourAK4->at(sortedJetIdx[1]))==4) 
               { 
                 C_SF_j2_l =breader_Cloose_CSVv294X->eval_auto_bounds("central", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
                 C_SF_j2_m =breader_Cmedium_CSVv294X->eval_auto_bounds("central", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
                 C_SF_j2_t =breader_Ctight_CSVv294X->eval_auto_bounds("central", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
               }
             else
               {
		 C_SF_j2_l =0;
	 ...
	 fillVariableWithValue("CSVv2SF_l_j1",C_SF_j1_l);
         fillVariableWithValue("CSVv2SF_m_j1",C_SF_j1_m);
         fillVariableWithValue("CSVv2SF_t_j1",C_SF_j1_t);

         fillVariableWithValue("CSVv2SF_l_j2",C_SF_j2_l);
         fillVariableWithValue("CSVv2SF_m_j2",C_SF_j2_m);
         fillVariableWithValue("CSVv2SF_t_j2",C_SF_j2_t);
         ...
         if(!isData)
         {
            //Jet 1
             if (abs(hFlavourAK4->at(sortedJetIdx[0]))==5)
               {
                 D_SF_j1_l =breader_Bloose_DeepCSV94X->eval_auto_bounds("central", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
                 D_SF_j1_m =breader_Bmedium_DeepCSV94X->eval_auto_bounds("central", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
                 D_SF_j1_t =breader_Btight_DeepCSV94X->eval_auto_bounds("central", BTagEntry::FLAV_B,ak4j1.Eta(),ak4j1.Pt());
               }
             else if (abs(hFlavourAK4->at(sortedJetIdx[0]))==4)
               {
                 D_SF_j1_l =breader_Cloose_DeepCSV94X->eval_auto_bounds("central", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
                 D_SF_j1_m =breader_Cmedium_DeepCSV94X->eval_auto_bounds("central", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
                 D_SF_j1_t =breader_Ctight_DeepCSV94X->eval_auto_bounds("central", BTagEntry::FLAV_C,ak4j1.Eta(),ak4j1.Pt());
               }
             else
               {
                 D_SF_j1_l =0;
            ...
            //Jet 2
             if (abs(hFlavourAK4->at(sortedJetIdx[1]))==5)
               {
                 D_SF_j2_l =breader_Bloose_DeepCSV94X->eval_auto_bounds("central", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
                 D_SF_j2_m =breader_Bmedium_DeepCSV94X->eval_auto_bounds("central", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
                 D_SF_j2_t =breader_Btight_DeepCSV94X->eval_auto_bounds("central", BTagEntry::FLAV_B,ak4j2.Eta(),ak4j2.Pt());
               }
             else if (abs(hFlavourAK4->at(sortedJetIdx[1]))==4) 
               {
                 D_SF_j2_l =breader_Cloose_DeepCSV94X->eval_auto_bounds("central", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
                 D_SF_j2_m =breader_Cmedium_DeepCSV94X->eval_auto_bounds("central", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
                 D_SF_j2_t =breader_Ctight_DeepCSV94X->eval_auto_bounds("central", BTagEntry::FLAV_C,ak4j2.Eta(),ak4j2.Pt());
               }
             else 
               {
                 D_SF_j2_l = 0;
         ...
         fillVariableWithValue("DeepSF_l_j1",D_SF_j1_l);
         fillVariableWithValue("DeepSF_m_j1",D_SF_j1_m);
         fillVariableWithValue("DeepSF_t_j1",D_SF_j1_t);

         fillVariableWithValue("DeepSF_l_j2",D_SF_j2_l);
         fillVariableWithValue("DeepSF_m_j2",D_SF_j2_m);
         fillVariableWithValue("DeepSF_t_j2",D_SF_j2_t);
...
double analysisClass::bTagEventWeight(const vector<double>& SFsForBTaggedJets, const unsigned int nBTags)
{
  ...
  /*
    ...
    Event weight matrix:
    ------------------------------------------------------------------
    #TrueBjet(m)\b-tagged jets(n)  |    0        1             2
    ------------------------------------------------------------------
  ...
  */
  ...
  int TBjet = SFsForBTaggedJets.size();

  double weight = 0;  

  if (TBjet<nBTags) return weight;

  switch (TBjet)
  {
   case 1 : switch(nBTags)
	    {
	      case 0: weight = 1 - SFsForBTaggedJets.at(0);
	         break;
	      case 1: weight = SFsForBTaggedJets.at(0);
	 	 break;
	    }
     break;
   case 2 : switch(nBTags)
	    {
	      case 0: weight = (1 - SFsForBTaggedJets.at(0))* (1 - SFsForBTaggedJets.at(1));
		 break;
	      case 1: weight = SFsForBTaggedJets.at(0)* (1 - SFsForBTaggedJets.at(1)) + SFsForBTaggedJets.at(1) * (1 - SFsForBTaggedJets.at(0));
		 break;
              case 2: weight = SFsForBTaggedJets.at(0)*SFsForBTaggedJets.at(1);
	         break;
            }
     break;
   default : weight = 1;
